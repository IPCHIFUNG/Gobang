...
void MainWindow::showWinnerDialog(int type)
{
	...
	case ChessType::BLACKCHESS:		// 黑棋获胜
		QMessageBox::information(this, tr("Inquire"), QString::fromLocal8Bit("黑棋"), QMessageBox::NoButton);
		break;
	case ChessType::WHITECHESS:		// 白棋获胜
		QMessageBox::information(this, tr("Inquire"), QString::fromLocal8Bit("白棋"), QMessageBox::NoButton);
		break;
